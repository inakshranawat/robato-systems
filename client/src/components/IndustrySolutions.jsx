          ...
          >
            ...
            <div className="space-y-4 text-left">
              {industry.points.map((point, pointIndex) => (
                ...
                >
                  <span className="text-purple-400 font-bold text-xl mt-1 flex-shrink-0">
                    •
                  </span>
