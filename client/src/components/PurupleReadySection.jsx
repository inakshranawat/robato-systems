...
export default function PurupleReadySection() {
    
  const {setDemoOpen} = useAppContext()

  return (
    <div className="relative min-h-screen bg-gradient-to-br from-purple-900 via-violet-900 to-indigo-950 overflow-hidden">
      {/* Simplified background - single gradient mesh */}
      <div className="absolute inset-0 bg-gradient-to-tr from-fuchsia-500/20 via-purple-500/10 to-cyan-500/20"></div>
      ...
      <div className="absolute inset-0 opacity-30">
        <div className="absolute top-0 left-1/4 w-1 h-full bg-gradient-to-b from-transparent via-purple-300/50 to-transparent transform -rotate-12"></div>
        <div className="absolute top-0 right-1/3 w-1 h-full bg-gradient-to-b from-transparent via-fuchsia-300/40 to-transparent transform rotate-6"></div>
      </div>
      
      {/* Simplified corner piece */}
      <div className="absolute top-0 right-0 w-96 h-96 opacity-60">
        <div className="absolute inset-0 bg-gradient-to-bl from-purple-500/30 via-fuchsia-600/20 to-transparent transform rotate-12 translate-x-32 -translate-y-20"></div>
      ...
      <div className="relative z-20 flex flex-col items-start justify-center min-h-screen px-8 md:px-16 lg:px-24">
        <div className="max-w-5xl">
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-black text-transparent bg-clip-text bg-gradient-to-r from-white via-purple-100 to-white mb-8 leading-tight">
            READY FOR YOUR<br />
            FREE TRIAL?
          </h1>
          ...
          <button className="group relative bg-white text-purple-900 font-bold text-lg px-10 py-5 mb-6 overflow-hidden transition-all duration-300 hover:scale-105">
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-purple-100 to-fuchsia-100 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
          </button>
