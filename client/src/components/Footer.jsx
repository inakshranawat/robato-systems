...
import { footer_bg } from "../assets/assets";
  ...
  return (
    <footer className="bg-black text-white">
      ...
      <div className="relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-blue-950 via-purple-950 to-blue-900 opacity-80"></div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400 text-sm">
              <li>
                <Link to="/production-monitoring" className="hover:text-white transition-colors">
                  Production Monitoring
                </Link>
              </li>
              <li>
                <Link to="/condition-monitoring" className="hover:text-white transition-colors">
                  Condition Monitoring
                </Link>
              </li>
              <li>
                <Link to="/predictive-maintenance" className="hover:text-white transition-colors">
                  Predictive Maintenance
                </Link>
              </li>
              <li>
                <Link to="/process-optimization" className="hover:text-white transition-colors">
                  Process Optimization
                </Link>
              </li>
              <li>
                <Link to="/machine-builders" className="hover:text-white transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400 text-sm">
              <li>
                <Link to="/electronic-message-display" className="hover:text-white transition-colors">
                  Electronic Message Display
                </Link>
              </li>
              <li>
                <Link to="/andon-tower-light" className="hover:text-white transition-colors">
                  Andon Tower Light
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400 text-sm">
              <li><Link to="/aerospace-defense" className="hover:text-white transition-colors">Aerospace & Defense</Link></li>
              <li><Link to="/automotive" className="hover:text-white transition-colors">Automotive</Link></li>
              <li><Link to="/contract-manufacturers" className="hover:text-white transition-colors">Contract Manufacturers</Link></li>
              <li><Link to="/heavy-machinery" className="hover:text-white transition-colors">Heavy Machinery</Link></li>
              <li><Link to="/medical-devices" className="hover:text-white transition-colors">Medical Devices</Link></li>
