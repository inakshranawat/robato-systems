...
import { automationtabletImg, MedicalBgImg, medicalDeviceQuestion, ProductionLaptopImg } from '@/Assets/assets';
...
import ShopFloor from '@/components/ShopFloor.jsx';
import MachinoxProApplication from '@/components/MachinoxProApplication.jsx';
...
function Page() {
  ...
  <Image
    ...
    alt="Medical Device Manufacturing Background"
    fill
    priority
...
{/**  Achieve peak throughput & enhance production quality*/}
      ...
      <div className="px-6 md:px-20 lg:px-30 py-10 md:py-20">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-10">
            ...
            src="/images/production-laptop.png"
            alt=""
            width={900}
            height={900}
          />
   ...
   <div className="px-6 md:px-20 lg:px-30 py-10 md:py-20">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-10">
          ...
          <motion.div
            ...
            className="w-full sm:w-[400px] md:w-[900px]"
            src="/images/automationtablet.png"
            alt=""
            width={900}
            height={900}
          />
...
{/**industry solutions */}
      ...
      <div className="mt-6 sm:mt-8 md:mt-10 flex-1 overflow-y-auto h-[400px] sm:h-[500px] md:h-[600px] pr-1 sm:pr-2">
        {medicalDeviceQuestion.map((item, index) => (
          <div
            key={index}
