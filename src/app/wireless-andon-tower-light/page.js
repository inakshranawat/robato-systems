...
const {setDemoOpen} = useAppContext()
  ...
  const useCases = [
      {
        icon: "/icons/PRODUCTION-FLOORS.png",
      ...
      {
        icon: "/icons/MAINTENANCE-OPTIMIZATION.png",
        title: "MAINTENANCE ",
    ...
    <div className="mb-10 px-4 sm:px-8">
      ...
      >
        {[
          ...
          >
            <Image className="w-16 lg:w-20 mx-auto lg:mx-0 lg:ml-10" src={item.src} width={100} height={100} alt={item.title} />
