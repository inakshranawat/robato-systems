...
import { aerospaceQuestion } from '@/Assets/assets'
import { ChevronDown } from 'lucide-react';
import {  AnimatePresence } from "framer-motion";
import { aerospaceBgImg,aerospacelaptopImg,cncTabletImg } from '@/Assets/assets';
      ...
      <div className="px-6 md:px-20 lg:px-30 py-10 md:py-20">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-10">
          ...
          <div>
            ...
            >
              <button onClick={()=> router.push('/contact-us')} className="text-white hover:bg-gray-600 hover:text-black bg-purple-900 px-6 md:px-10 py-3">
                GET A QUOTE
              </button>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-10">
          ...
          <motion.div
           initial={{ opacity: 0, x: 100 }}
            ...
            className="w-full sm:w-[400px] md:w-[900px]"
            src="/images/aerospace-laptop.png"
            alt=""
            width={900}
            height={900}
          />
